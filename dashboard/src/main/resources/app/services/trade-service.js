(function () {
    ...
    function TradeService($http) {
        ...
        service.tradeProcessingDuration = tradeProcessingDuration;

        return service;

        function tradeProcessingDuration() {
          return $http({
              url : vdbURL
              ,method : 'GET'
            }).then(handleSuccess, handleError('Error TradeService.tradeProcessingDuration'));
        }
    ...
    // Base64 encoding service used by TradeService
    var Base64 = {
